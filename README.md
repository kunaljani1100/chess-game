...
2. The game starts with white to move. Click on a piece that you want to move. When the piece is clicked, the background color of the square will turn to yellow.
3. If you clicked a piece by accident, then click on the piece again so that you can click on another piece to move.
